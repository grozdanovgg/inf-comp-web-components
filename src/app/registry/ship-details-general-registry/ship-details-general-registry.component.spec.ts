...
describe('ShipDetailsGeneralRegistryComponent', () => {
  let component: ShipDetailsGeneralRegistryComponent;
  let fixture: ComponentFixture<ShipDetailsGeneralRegistryComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ShipDetailsGeneralRegistryComponent]
    })
      .compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(ShipDetailsGeneralRegistryComponent);
